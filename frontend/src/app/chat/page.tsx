...
export default function ChatPage() {
    ...
    return (
        <div className="flex w-screen min-h-screen h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 transition-colors duration-300 absolute">
            {/* Mobile Overlay */}
            {sidebarOpen && (
                <div
            ...
            <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
                } fixed md:static md:translate-x-0 top-0 left-0 h-full w-80 transition-transform duration-300 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 flex flex-col z-50 md:z-auto`}>
                {/* Sidebar Header */}
